...
//
// 键的组成： [列值编码] [+ 行定位 6B（仅叶子：页号 u32 + 槽号 u16）]
...
// 前缀 —— 例如 INT32 值 -2147387271（补码 0x80017879）的保序编码恰为
// 00 01 78 79，于是 (NULL, "xy") 与 (-2147387271, "") 会拼出**完全相同**
// 的键（00 01 78 79 00 00），两种解析都合法。
//
